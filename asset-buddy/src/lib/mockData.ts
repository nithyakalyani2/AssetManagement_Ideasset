...
export const assetRequests: AssetRequest[] = [
  {
    ...
    assetType: "Laptop",
    reason:
      "Current laptop is slow and affecting productivity. Need upgrade for video editing tasks.",
    priority: "High",
    status: "pending",
  ...
  },
  {
    ...
    assetType: "Monitor",
    reason: "Need additional monitor for multi-tasking during deployments.",
    priority: "Medium",
    status: "pending",
  ...
  },
  {
    ...
    assetType: "Headset",
    reason: "For remote interviews and team calls.",
    priority: "Low",
    status: "pending",
  ...
  },
  {
    ...
    reason: "Need docking station for home office setup.",
    priority: "Medium",
    status: "approved",
  ...
  },
  {
    ...
    assetType: "Webcam",
    reason: "Better quality webcam for client presentations.",
    priority: "Low",
    status: "rejected",
...
export const assetHistory: AssetHistory[] = [
  ...
  },
  {
    ...
    action: "Repair",
    date: "2024-02-28",
    notes: "Screen flickering issue - sent to vendor",
  },
  {
    id: "5",
    assetId: "DCK-001",
...
export const complaints: Complaint[] = [
  {
    ...
    subject: "Laptop overheating during heavy usage",
    description:
      "My MacBook Pro gets extremely hot when running multiple applications. The fans run at full speed constantly.",
    relatedAssetId: "LPT-001",
    priority: "High",
    status: "in-progress",
  ...
  },
  {
    ...
    description:
      "The company VPN disconnects every 30 minutes, requiring me to reconnect manually. This is affecting my productivity.",
    priority: "Medium",
    status: "open",
  ...
  },
  {
    ...
    subject: "Cannot access design server",
    description:
      "I am unable to connect to the design assets server. Getting permission denied error.",
    priority: "High",
    status: "resolved",
    ...
    assignedTo: "IT Admin",
    resolution:
      "Access permissions have been updated. Please try reconnecting.",
  },
  {
    id: "CMP004",
    employeeId: "EMP003",
    ...
    subject: "Slow internet in meeting room B",
    description:
      "The WiFi in meeting room B is extremely slow during video calls. Other rooms work fine.",
    priority: "Low",
    status: "open",
  ...
  },
  {
    ...
    description:
      "I need assistance setting up a second monitor for my workstation. The monitor is available but I need help with configuration.",
    priority: "Low",
    status: "closed",
    createdDate: "2024-02-10",
    updatedDate: "2024-02-12",
    resolution: "Second monitor has been configured and is working properly.",
  },
];
